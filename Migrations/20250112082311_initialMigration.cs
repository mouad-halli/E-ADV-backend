        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisiteId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    GeneralComment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GeneralFeedback = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPresentations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductPresentations_Appointments_AppointmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ProductPresentationId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSlides_ProductPresentations_ProductPresentationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPresentations_AppointmentId",
                table: "ProductPresentations",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSlides_ProductPresentationId",
                table: "ProductSlides",
